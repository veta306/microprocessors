...
import { getMicroprocessor } from "../utils/api";
import Header from "../components/Header";
import { updateProcessor } from "../utils/api";

export default function EditPage() {
  const navigate = useNavigate();
  const { id } = useParams();
  const [processor, setProcessor] = useState();
  const [igpuVisible, setigpuVisible] = useState();
  useEffect(() => {
    const getData = async () => {
      const response = await getMicroprocessor(id);
      setProcessor(response.data[0]);
      setigpuVisible(processor?.igpu_id);
    };
    getData();
  }, [processor?.igpu_id, id]);

  const handleSubmit = async (e) => {
    e.preventDefault();
    const formData = new FormData(e.target);
    try {
      console.log(igpuVisible);
      const response = await updateProcessor({
      ...
      if (response.status === 200) navigate(`/processor/${id}`);
    } catch (error) {
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-2">
                    <input
                      type="text"
                      name="manufacturer"
                      defaultValue={processor.manufacturer_name}
                      id="manufacturer"
                      required
                      className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    />
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="mt-2">
                    <input
                      id="socket"
                      name="socket"
                      defaultValue={processor.socket_name}
                      required
                      type="text"
                      className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    />
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="mt-2">
                    <select
                      id="type"
                      name="type"
                      defaultValue={processor.type_name}
                      required
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      name="released"
                      required
                      defaultValue={new Date(processor.released)
                        .toISOString()
                        .slice(0, 10)}
                      id="released"
                      className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      required
                      id="threads"
                      defaultValue={processor.threads}
                      className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    />
                  </div>
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      id="base"
                      step="0.1"
                      defaultValue={processor.base_clock}
                      className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    />
                  </div>
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      id="boost"
                      step="0.1"
                      defaultValue={processor.boost_clock}
                      className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    />
                  </div>
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      required
                      id="process"
                      defaultValue={processor.process}
                      className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    />
                  </div>
                </div>
                  ...
                  <>
                    <div className="mt-2 col-span-full">
                      ...
                      <input
                        ...
                        name="iGPU"
                        id="iGPU"
                        defaultValue={processor.igpu_model}
                        required
                        className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                      />
                    </div>
                    <div className="sm:col-span-2 sm:col-start-1">
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          required
                          step="0.1"
                          defaultValue={processor.igpu_base_clock}
                          className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                        />
                      </div>
                    </div>
                    ...
                    <div className="sm:col-span-2">
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          required
                          step="0.1"
                          defaultValue={processor.igpu_boost_clock}
                          className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                        />
                      </div>
                    </div>
                    ...
                    <div className="sm:col-span-2">
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          required
                          step="0.1"
                          defaultValue={processor.igpu_flops}
                          className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                        />
                      </div>
                    </div>
